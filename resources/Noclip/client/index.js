...
alt.on("Noclip:Config", (value) => {
  if (!value) {
      ...
      addTemporaryText(`NoclipStatus`, `Noclip: Off`, 0.95, 0.2, 0.4, 255, 255, 255, 255, 2000);
      return;
  }
  ...
  addTemporaryText(`NoclipStatus`, `Noclip: On`, 0.95, 0.2, 0.4, 255, 255, 255, 255, 2000);
});
